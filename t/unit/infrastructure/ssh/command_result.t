...
subtest 'Constructor and Attributes' => sub {
    subtest 'Required attributes' => sub {
        my $result1 = dies { 
            TorrustDeploy::Infrastructure::SSH::CommandResult->new() 
        };
        ok $result1, 'dies without required attributes';
        like $result1, qr/required/, 'error message mentions required attribute';
        
        my $result2 = dies { 
            TorrustDeploy::Infrastructure::SSH::CommandResult->new(output => 'test') 
        };
        ok $result2, 'dies without exit_code';
        
        my $result3 = dies { 
            TorrustDeploy::Infrastructure::SSH::CommandResult->new(exit_code => 0) 
        };
        ok $result3, 'dies without output';
    };
    
    subtest 'Valid construction' => sub {
        my $result = TorrustDeploy::Infrastructure::SSH::CommandResult->new(
            output => 'test output',
            exit_code => 0,
        );
    ...
    subtest 'Success computation' => sub {
        my $success_result = TorrustDeploy::Infrastructure::SSH::CommandResult->new(
            output => 'success',
            exit_code => 0,
        );
        ok $success_result->success, 'exit_code 0 means success';
        
        my $failure_result = TorrustDeploy::Infrastructure::SSH::CommandResult->new(
            output => 'error',
            exit_code => 1,
        );
        ok !$failure_result->success, 'exit_code 1 means failure';
        
        my $other_failure = TorrustDeploy::Infrastructure::SSH::CommandResult->new(
            output => 'error',
            exit_code => 255,
        );
...
subtest 'Factory Methods' => sub {
    subtest 'success_result factory' => sub {
        my $result = TorrustDeploy::Infrastructure::SSH::CommandResult->success_result('output');
        ...
        my $custom_result = TorrustDeploy::Infrastructure::SSH::CommandResult->success_result('output', 0);
        is $custom_result->exit_code, 0, 'custom exit_code can be provided';
    };
    
    subtest 'failure_result factory' => sub {
        my $result = TorrustDeploy::Infrastructure::SSH::CommandResult->failure_result('error message');
        ...
        # With custom exit code
        my $custom_result = TorrustDeploy::Infrastructure::SSH::CommandResult->failure_result('error', 1);
        is $custom_result->exit_code, 1, 'custom exit_code can be provided';
    };
};

subtest 'Convenience Methods' => sub {
    my $success_result = TorrustDeploy::Infrastructure::SSH::CommandResult->success_result('output');
    my $failure_result = TorrustDeploy::Infrastructure::SSH::CommandResult->failure_result('error');
    ...
    subtest 'has_output method' => sub {
        ...
        my $empty_result = TorrustDeploy::Infrastructure::SSH::CommandResult->new(
            output => '',
            exit_code => 0,
        );
        ok !$empty_result->has_output, 'has_output returns false for empty string';
        
        my $undef_result = TorrustDeploy::Infrastructure::SSH::CommandResult->new(
            output => undef,
            exit_code => 0,
        );
